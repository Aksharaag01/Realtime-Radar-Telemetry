...
if(NOT TARGET __zenohc_shared)
    ...
    set_target_properties(__zenohc_shared PROPERTIES
        ...
        IMPORTED_LOCATION "${PACKAGE_PREFIX_DIR}/bin/zenohc.dll"
        INTERFACE_INCLUDE_DIRECTORIES "${PACKAGE_PREFIX_DIR}/include"
    )
    if(NOT ("libzenohc.dll.a" STREQUAL ""))
        set_property(TARGET __zenohc_shared PROPERTY IMPORTED_IMPLIB "${PACKAGE_PREFIX_DIR}/lib/libzenohc.dll.a")
    endif()
endif()
if(NOT TARGET __zenohc_static)
    ...
    target_link_libraries(__zenohc_static INTERFACE ws2_32;crypt32;secur32;bcrypt;ncrypt;userenv;ntdll;iphlpapi;runtimeobject)
